                        ...
                        <tr v-for="(horario, hora) in horarios">
                            ...
                            <td v-for="(clase, dia) in horario">
                                <div v-for="aula in clase">
                                     <div v-if="aula.grupo_docente_id == grupo_docente_id"
                                          v-on:click="verMas(aula)"
    ...
    export default {
        ...
        methods:{
            ...
            obtenerHorarios(){
                ...
                this.axios
                    .get('/administrador/clases/'+this.grupo_docente.gestion_id)
                    .then((response)=>{
                        var datos = response.data;
                        this.clases = datos;
