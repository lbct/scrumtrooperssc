...
@section('titulo', 'SubirGuiaPractica')
      ...
      <div class="container col-md-5 col-md-offset-5 ">
          <div class="row">
              <div class="panel panel-default">
                  <div>
<!-- Funcion Para Hacer el Drag an Drop  
                  ...
                  <div>
                      <div>
                            <div class="row">
                                 ...
                                 <div class="col-sm-4"><input type="submit" value="Cancelar" class="btn btn-primary" tabindex="7" style="margin:10px">
                                      <div class="dropdown">
                                      <div class="col-sm-4"button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Semana
